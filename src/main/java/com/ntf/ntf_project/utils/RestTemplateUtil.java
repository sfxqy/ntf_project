...
public class RestTemplateUtil {
  ...
  public String postFormData(String url, MultiValueMap<String, String> map) {
    ...
    HttpEntity<MultiValueMap<String, String>> requests = new HttpEntity<MultiValueMap<String, String>>(
        map, headers);
  ...
  public ResponseEntity postJsonDataAndReturnEntity(String url, JSONObject param) {
    HttpHeaders headers = new HttpHeaders();
    ...
    ResponseEntity<JSONObject> responseEntity = restTemplate
        .postForEntity(url, requestEntity, JSONObject.class);
  ...
  public String postXml(String url, String xml) {
    ...
    try {
      return new String(Objects.requireNonNull(responseEntity.getBody()).getBytes("ISO8859-1"),
